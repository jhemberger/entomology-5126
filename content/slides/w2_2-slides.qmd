...
::: indented-text
<i class="fa-solid fa-turn-up fa-rotate-90"></i> Distribution is symmetric about the expectation, $\mu$, such that:
:::
...
::: box-6-list
If there are so many different distributions that our data can originate from, why are we spending so much time bothering with normal distributions?
:::

. . . 

Let's do a bunch of sampling of a couple of non-normal distributions and see what we find...

. . . 

This finding, that any random variable that is itself the average of multiple independent random variables results in a standard normal random variable (i.e., a normal distribution), is called the [central limit theorem]{.highlight-tomato}

## Summary

::: box-6-list
Key to remember here is that for any random variable, whether continuous or discrete, can be characterized by:
:::

. . . 

::: indented-text
<i class="fa-solid fa-turn-up fa-rotate-90"></i> Exact probability values for a particular value (discrete distribution) or interval (continuous distribution) of the variable
:::

. . . 

::: indented-text
<i class="fa-solid fa-turn-up fa-rotate-90"></i> An expectation, $E(X)$
:::

. . . 

::: indented-text
<i class="fa-solid fa-turn-up fa-rotate-90"></i> A variance, $\sigma^2(X)$
:::

. . . 

::: box-6-list
This information alone can help us to describe our data, calculate probabilities of certain values, test hypotheses, and conduct parameter inference
:::
