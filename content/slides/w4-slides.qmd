...
4. Math time! Imagine we have a random variable, $Y \sim N(20, 3^2)$. Calculate the probability that our random variable takes the values between 20 and 23 (i.e., $P(20 ≤ Y ≤ 23)$). I'll give you a critical piece you need here...$P(Z ≥ 1) = 0.1587$.
