...
::: box-1-list
[{{< fa floppy-disk >}}]{.margin-1} Data best management practices
:::

. . .

::: box-1-list
[{{< fa hat-cowboy >}}]{.margin-1} A brief introduction to data wranglin'
:::
...
## What this course isn't {.smaller}
...
## Some basic expectations {.smaller}
...
## Learning objectives for the semester {.smaller}
...
![](slide_media/w1/ferpa.png){width="60%" fig-align="center"}


![](slide_media/w1/hipaa){width="60%" fig-align="center"}
...
![](slide_media/w1/metadata.png){width="100%" fig-align="center"}
