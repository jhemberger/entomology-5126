---
title: "Lab 2: data wrangling and basic plotting"
...
8. Try reproducing the above scatterplot matrix in ggplot instead of Base R. Do the same for the boxplot below. 
