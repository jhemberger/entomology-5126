...
<p class="buttons" style="text-align:left;"><span class="btn btn-outline-warning">{{< fa brands r-project title="R Project">}} [Download R](https://cran.r-project.org/)</span>    <span class="btn btn-outline-warning">{{< fa registered >}} [Download RStudio](https://posit.co/download/rstudio-desktop/)</span>    <span class="btn btn-outline-warning">{{< fa cloud >}} [Launch Posit Cloud](https://posit.cloud/)</span></p>
